...
//            gainResource();
            gainGas();
            //建物.生成人()
            this.citizens.add(buildings.getNewCitizenNum(resource), Base.BASE_X+ Global.SUM_OF_CAMERA_MOVE_VX-75,Base.BASE_Y+Global.SUM_OF_CAMERA_MOVE_VY);
            this.military.addArmy(buildings.getNewArmyNum(resource),Base.BASE_X+Global.SUM_OF_CAMERA_MOVE_VX+Base.BASE_WIDTH+75,Base.BASE_Y+Global.SUM_OF_CAMERA_MOVE_VY); //Base.BASE_X+225,Base.BASE_Y
