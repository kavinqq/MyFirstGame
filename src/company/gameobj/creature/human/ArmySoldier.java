...
public class ArmySoldier extends Soldier  {  //士兵
    ...
    public ArmySoldier(int x, int y, int level){
        ...
        super(x,y, painterWidth, painterHeight, colliderWidth, colliderHeight,  50 * level + 50, SPEED, new Path().img().actors().Actor2(), FLY_ABILITY.CANNOT_FLY, SOLDIER_TYPE.ARMY);
        setMaxHp(400);
